...
import br.com.jkavdev.fullcycle.subscription.infrastructure.authentication.principal.KeycloakJwtConverter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(final KeycloakJwtConverter jwtConverter) {
