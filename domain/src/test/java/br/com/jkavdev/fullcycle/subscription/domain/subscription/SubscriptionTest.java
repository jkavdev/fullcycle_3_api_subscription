...
//        Assertions.assertInstanceOf(AccountEvent.AccountCreated.class, actualSubscription.domainEvents().getFirst());
    }
...
//        Assertions.assertTrue(expectedEvents, actualSubscription.domainEvents().empty());
    }
